...
export default function Footer() {
  return (
    <footer
      className="bg-white border-t border-slate-200 pt-20 pb-10 px-6"
      role="contentinfo"
      aria-label="Informasi kontak dan navigasi tambahan"
    >
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          <div className="col-span-2">
            <Link
              ...
              aria-label="NusantaraExport.AI - Kembali ke halaman utama"
            >
              <div
                className="w-10 h-10 bg-accent rounded-lg flex items-center justify-center text-white shadow-lg"
                aria-hidden="true"
              >
            ...
            <p className="text-secondary/50 font-medium max-w-sm mb-4 leading-relaxed">
              Membantu jutaan UMKM Indonesia merambah pasar global melalui
              teknologi AI yang inklusif dan ramah disabilitas.
            </p>
          </div>
