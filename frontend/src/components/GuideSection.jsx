...
export default function GuideSection() {
  const steps = [
    ...
    },
    {
      ...
      tip: "Bisa pakai bahasa daerah atau Indonesia sehari-hari.",
    },
    {
      step: "3",
      icon: <Hourglass />,
      title: "Tunggu Analisis AI (< 30 detik)",
      desc: "Sistem akan mengecek harga pasar, menghitung peluang, dan menyiapkan rekomendasi.",
      tip: "Koneksi internet stabil memastikan data yang paling baru.",
    },
    {
      step: "4",
      icon: <ClipboardCheck />,
      title: "Baca Rekomendasi & Unduh Dokumen",
      desc: "Anda akan mendapat: negara tujuan terbaik, estimasi margin, dan dokumen ekspor siap cetak.",
      tip: "Gunakan fitur suara agar mudah dipahami oleh mitra bisnis Anda.",
    },
  ];
      ...
      <div className="max-w-4xl mx-auto">
            ...
            <div key={i} className="flex gap-6">
              ...
              <div className="pb-10">
                ...
                <div className="flex items-start gap-2 px-3 py-2.5 bg-accent-light border border-accent/10 rounded-xl text-xs text-accent leading-relaxed font-bold">
                  <span className="flex-shrink-0"><Lightbulb size={14} /></span>
                  <span>{s.tip}</span>
                </div>
              </div>
            </div>
        ...
        <div className="text-center flex flex-col items-center gap-4 px-8 py-12 rounded-3xl border border-accent/20 bg-accent-light/50 mt-8">
          ...
          <p className="text-sm text-secondary/60 max-w-sm leading-relaxed font-medium">
            NusantaraExport.AI tersedia untuk semua UMKM Indonesia — dari Sabang
            sampai Merauke.
          </p>
          <Link
            to="/demo"
          ...
          >
            <Rocket size={18} /> Mulai Analisis Gratis
          </Link>
        </div>
      </div>
    </section>
